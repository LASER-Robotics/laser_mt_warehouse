...
echo_and_run cd "/home/pedrolucas/catkin_turtlebot/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pedrolucas/catkin_turtlebot/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/pedrolucas/catkin_turtlebot/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
