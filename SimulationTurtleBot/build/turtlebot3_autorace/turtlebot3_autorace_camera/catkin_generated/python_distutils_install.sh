...
echo_and_run cd "/home/pedrolucas/catkin_turtlebot/src/turtlebot3_autorace/turtlebot3_autorace_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pedrolucas/catkin_turtlebot/src/turtlebot3_autorace/turtlebot3_autorace_camera/setup.py" \
     \
    build --build-base "/home/pedrolucas/catkin_turtlebot/build/turtlebot3_autorace/turtlebot3_autorace_camera" \
    install \
    --root="${DESTDIR-/}" \
