...
echo_and_run cd "/home/pedrolucas/catkin_turtlebot/src/turtlebot3_autorace/turtlebot3_autorace_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pedrolucas/catkin_turtlebot/src/turtlebot3_autorace/turtlebot3_autorace_detect/setup.py" \
     \
    build --build-base "/home/pedrolucas/catkin_turtlebot/build/turtlebot3_autorace/turtlebot3_autorace_detect" \
    install \
    --root="${DESTDIR-/}" \
