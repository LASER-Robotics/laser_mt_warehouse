#include "/home/pedrolucas/catkin_turtlebot/src/path_planner/include/astar.hpp"
#include <iostream>
#include <list>
#include <map>
#include <fstream>
...
void Astar::setStartnEnd(int x1, int y1, int x2, int y2){
	...
	imwrite("/home/pedrolucas/catkin_turtlebot/src/path_planner/src/mazeSolved.png", image);//image to use
}
...
void Astar::solveAstar(){
	...
	if (end != nullptr){
		...
		imwrite("/home/pedrolucas/catkin_turtlebot/src/path_planner/src/mazeSolved.png", image); //desenhar
		...
		//arquivo
		ofstream file;
		file.open("/home/pedrolucas/catkin_turtlebot/src/path_planner/src/coords.csv"); 
		if(file.is_open()){

		file << "X" << "," << "Y" << endl;

			for(int i = 0; i < xs.size(); i++){
				file << coordinates[i].first << ","  << coordinates[i].second << endl;
			}
...
int main(){
	...
	Astar pathLab = Astar("/home/pedrolucas/catkin_turtlebot/src/path_planner/src/mazeToSolve.png");
